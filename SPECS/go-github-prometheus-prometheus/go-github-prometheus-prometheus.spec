...
BuildRequires:  go(github.com/open-telemetry/opentelemetry-collector-contrib)
...
BuildRequires:  go(github.com/stackitcloud/stackit-sdk-go)
...
Requires:       go(github.com/coreos/go-systemd)
...
Requires:       go(github.com/open-telemetry/opentelemetry-collector-contrib)
...
Requires:       go(github.com/stackitcloud/stackit-sdk-go)
