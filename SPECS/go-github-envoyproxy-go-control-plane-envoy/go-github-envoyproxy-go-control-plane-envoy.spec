...
BuildOption(prep):  -n go-control-plane-envoy-v%{version}
# The envoy tag contains a nested Go module below the archive root. Keep prep
# at the root so shared LICENSE/README files are available, then enter the
