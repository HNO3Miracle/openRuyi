...
Source0:        https://github.com/open-telemetry/opentelemetry-go/archive/refs/tags/trace/v%{version}.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n opentelemetry-go-trace-v%{version}
