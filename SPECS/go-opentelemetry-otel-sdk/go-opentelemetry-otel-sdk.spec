...
Source0:        https://github.com/open-telemetry/opentelemetry-go/archive/refs/tags/sdk/v%{version}.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n opentelemetry-go-sdk-v%{version}
