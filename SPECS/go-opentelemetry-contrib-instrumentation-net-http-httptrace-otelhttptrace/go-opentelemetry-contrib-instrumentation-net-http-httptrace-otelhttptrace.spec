...
Source0:        https://github.com/open-telemetry/opentelemetry-go-contrib/archive/refs/tags/instrumentation/net/http/httptrace/otelhttptrace/v%{version}.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
